...
import manSmile from "../assets/Images/manSmile.png"
import delivered from "../assets/Images/delivered-goods.png"
  ...
  return (
    <div>
      ...
      <div className="text-center mt-40 mb-16 px-4 md:px-0 text-black">
        ...
        <p className="w-full md:w-[30rem] mt-4 sm:mt-6 lg:mt-8 mx-auto text-sm md:text-base text-gray-700">
      ...
      <div className="bg-gray-100 py-12 md:py-20 px-4 md:px-0">
        ...
        <div className="flex flex-col md:flex-col lg:flex-row lg:mx-10 justify-center items-center gap-8 md:gap-20">
          <div className="w-full md:w-auto">
            <img src={womanSmile} alt="Smiling woman" className="rounded-md w-full md:w-auto" />
          </div>
        ...
        <div className="flex flex-col gap-8 md:gap-10">
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-10 mx-auto">
            <div className="flex flex-col gap-4">
              <img src={food} alt="Food delivery" className="rounded-3xl w-full lg:w-auto" />
              <div className="bg-white p-4 rounded-lg shadow-md">
                <div className="flex justify-between items-center">
                  <h1 className="text-lg sm:text-xl-custom font-bold text-[#7a1212]">Food Delivery Services</h1>
            ...
            <div className="flex flex-col gap-4">
              <img src={uberEats} alt="Uber Eats" className="rounded-3xl w-full lg:w-auto" />
              <div className="bg-white p-4 rounded-lg shadow-md">
                <div className="flex justify-between items-center">
          ...
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-10 mx-auto">
            <div className="flex flex-col gap-4">
              <img src={delivered} alt="delivered" className="rounded-3xl w-full lg:w-auto" />
              <div className="bg-white p-4 rounded-lg shadow-md">
                <div className="flex justify-between items-center">
                  <h1 className="text-lg sm:text-xl-custom font-bold text-[#7a1212]">E-commerce Delivery</h1>
                  <FaArrowRight className="text-text-[#7a1212]" />
                </div>
                <p className="text-sm sm:text-base w-full md:w-96 mt-2 text-gray-700">
            ...
            <div className="flex flex-col gap-4">
              <img src={manSmile} alt="man-smile" className="rounded-3xl w-full lg:w-auto" />
              <div className="bg-white p-4 rounded-lg shadow-md">
                <div className="flex justify-between items-center">
                  <h1 className="text-lg sm:text-xl-custom font-bold text-[#7a1212]">On-Demand Delivery Services</h1>
